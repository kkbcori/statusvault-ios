...
const SECTIONS: Section[] = [
  {
    ...
    faqs: [
      ...
      { q: 'Is StatusVault free?', a: 'The free tier allows up to 3 documents. Premium ($3.99 one-time, no subscription) unlocks unlimited document tracking, advanced alert windows, data export, and priority support — pay once and the upgrade is yours forever across all your devices.' },
    ],
  },
  {
    id: 'documents',
